...
class Separation(torch.nn.Module):
    ...
    def forward(self, feat, is_eval=False):
        ...
        entmax_layer = Entmax(alpha=1.5)
        mask = entmax_layer(mask)
...
def ResNet18_FSR_1(num_classes=10, tau=0.1, image_size=(32, 32)):
